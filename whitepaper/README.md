...
* Provide guidance on serverless security topics such as: secure serverless development guidelines, hardening serverless deployments, adequate security logging and monitoring as well as relevant tools & procedures (Appendix B includes a reference to the guide "The 10 Most Critical Security Risks in Serverless Architectures")     
